...
class JournalistCategoryAccessTest(TestCase):    def setUp(self):
    ...
    def test_journalist_sees_category_link_in_nav(self):
        """Test que le journaliste voit le lien Catégories dans la navigation"""
        self.client.login(username='journalist', password='journalist123')
        response = self.client.get(reverse('home'))
        
        self.assertContains(response, 'href="/gerer-categories/"')
